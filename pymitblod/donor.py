...
# Method 1
nadlers_male_blood_volume_ml_lambda = lambda w,h: (0.3669 * h**3) + (0.03219 * w) + 0.6041
nadlers_female_blood_volume_ml_lambda = lambda w,h: (0.3561 * h**3) + (0.03308 * w) + 0.1833
# Method 2
lemmens_bernstein_brodsky_blood_volume_ml_lambda = lambda bmi: 70 / math.sqrt(bmi/22)
# Method 3
weight_height_male_blood_volume_ml_lambda = lambda a,w,h: (1486 * (w**0.425 * h**0.725) * 0.007184) - 825 + 1578 * (w**0.425 * h**0.725 * 0.007184)
weight_height_female_blood_volume_ml_lambda = lambda a,w,h: 1.06 * a + (822 * (w**0.425 * h**0.725 * 0.007184)) + 1395 * (w**0.425 * h**0.725 * 0.007184)
